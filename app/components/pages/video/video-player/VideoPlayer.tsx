...
import { BsFullscreen } from 'react-icons/all'
import { IoPause, IoPlay } from 'react-icons/io5'

import { usePlayer } from '@/components/pages/video/video-player/usePlayer'
import { IVideoPath } from '@/components/pages/video/video-player/video-payer.interface'

import styles from './VideoPlayer.module.scss'

const VideoPlayer: FC<IVideoPath> = ({ videoPath }) => {
